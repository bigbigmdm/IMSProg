    ...
    , ui(new Ui::DialogCompare)
{
    ...
    connect(hexEdit1->verticalScrollBar(),
            &QScrollBar::valueChanged,
            this,
            &DialogCompare::handleScroll1);
    connect(hexEdit2->verticalScrollBar(),
            &QScrollBar::valueChanged,
            this,
            &DialogCompare::handleScroll2);
}
...
{
    long posStart = 0, posEnd = 0, min = 0;
    int i;
...
void DialogCompare::showArrays(QByteArray *array1,
                               QByteArray *array2,
                               QString *name1,
                               QString *name2)
{
