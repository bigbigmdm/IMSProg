...
void DialogNandSecurity::on_toolButton_write_clicked()
{
    ...
    if (stCH341 == 0) {
        ...
        SPI_CONTROLLER_Write_One_Byte(0x00, programmerType);
        SPI_CONTROLLER_Write_One_Byte(0x00, programmerType);
        SPI_CONTROLLER_Write_NByte(buf.get(),
                                   currentSector,
                                   SPI_CONTROLLER_SPEED_SINGLE,
                                   programmerType);
        SPI_CONTROLLER_Chip_Select_High(programmerType);
...
void DialogNandSecurity::setAlgorithm(unsigned int currentAlg)
{
    ...
    algSettings algSet[] = {
        ...
        {0, 0x02, 0x0b},  {1, 0x00, 0x03},  {2, 0x00, 0x03},  {3, 0x02, 0x1f},  {4, 0x02, 0x0b},
        {5, 0x02, 0x1d},  {6, 0x02, 0x1f},  {7, 0x02, 0x1f},  {8, 0x02, 0x0b},  {9, 0x02, 0x0b},
        {10, 0x02, 0x1f}, {11, 0x00, 0x03}, {12, 0x02, 0x05}, {13, 0x00, 0x03}, {14, 0x02, 0x0b},
        {15, 0x02, 0x3f}, {16, 0x02, 0x3f}, {17, 0x00, 0x03}, {18, 0x00, 0x03},
    };
