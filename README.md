...
It contains the following controls: ![Undo](img/undo.png) undo, ![Redo](img/redo64.png) redo, and the ![Search](img/search64.png) search/replace. The `[Ctrl+A]` key used to update the CRC24 checksum.
