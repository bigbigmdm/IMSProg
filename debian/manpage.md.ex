...
imsprog - program to do something

# SYNOPSIS

**imsprog** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**imsprog** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **imsprog** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**imsprog** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    imsprog. See **foo.conf**(5) for further details.
...
**imsprog** provides some return codes, that can be used in scripts:
...
Mikhail Medvedev <e-ink-reader@yandex.ru>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright © 2007 Mikhail Medvedev
