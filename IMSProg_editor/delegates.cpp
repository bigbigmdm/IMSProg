...
chTypeDelegate::chTypeDelegate(QObject *parent)
    : QItemDelegate(parent)
{}
QWidget *chTypeDelegate::createEditor(QWidget *parent,
...
void chTypeDelegate::setModelData(QWidget *editor,
...
chVCCDelegate::chVCCDelegate(QObject *parent)
    : QItemDelegate(parent)
{}
QWidget *chVCCDelegate::createEditor(QWidget *parent,
                                     const QStyleOptionViewItem &option,
                                     const QModelIndex &index) const
{
    QComboBox *editor = new QComboBox(parent);
...
void chVCCDelegate::setModelData(QWidget *editor,
                                 QAbstractItemModel *model,
                                 const QModelIndex &index) const
{
    QComboBox *comboBox = static_cast<QComboBox *>(editor);
...
chPagesDelegate::chPagesDelegate(QObject *parent)
    : QItemDelegate(parent)
{}
QWidget *chPagesDelegate::createEditor(QWidget *parent,
                                       const QStyleOptionViewItem &option,
                                       const QModelIndex &index) const
{
    QComboBox *editor = new QComboBox(parent);
...
void chPagesDelegate::setModelData(QWidget *editor,
                                   QAbstractItemModel *model,
                                   const QModelIndex &index) const
{
    QComboBox *comboBox = static_cast<QComboBox *>(editor);
...
chBlSizeDelegate::chBlSizeDelegate(QObject *parent)
    : QItemDelegate(parent)
{}
QWidget *chBlSizeDelegate::createEditor(QWidget *parent,
                                        const QStyleOptionViewItem &option,
                                        const QModelIndex &index) const
{
    QComboBox *editor = new QComboBox(parent);
...
void chBlSizeDelegate::setModelData(QWidget *editor,
                                    QAbstractItemModel *model,
                                    const QModelIndex &index) const
{
    QComboBox *comboBox = static_cast<QComboBox *>(editor);
